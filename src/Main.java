...
//
//        graph.addRelation("EMPLOYS", lakers, lebron);
//        graph.addRelation("EMPLOYS", lakers, anthony);
//        graph.addRelation("EMPLOYS", lakers, russell);
//
//        graph.deleteNode(lebron);
//
//        graph.print();
